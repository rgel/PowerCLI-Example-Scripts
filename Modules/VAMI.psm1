...
.EXAMPLE
    PowerCLI C:\> Connect-CisServer -Server 192.168.1.51 -User administrator@vsphere.local -Password VMware1!
    PowerCLI C:\> Get-VAMISummary
.NOTES
	Created by  :: William Lam @lamw
	Edited by   :: Roman Gelman @rgel
	...
	foreach ($Server in ($global:DefaultCisServers | ? { $_.IsConnected }))
	{
		Try
		{
			...
			$healthResult = [pscustomobject] @{
				...
				HealthLastCheck = (Get-Culture).TextInfo.ToTitleCase($healthLastCheck)
...
.EXAMPLE
    PowerCLI C:\> Connect-CisServer -Server 192.168.1.51 -User administrator@vsphere.local -Password VMware1!
    PowerCLI C:\> Start-VAMIDiskResize -Server 192.168.1.51 -Verbose
.NOTES
	Created by  :: William Lam @lamw
	Edited by   :: Roman Gelman @rgel
	Requirement :: PowerCLI 6.5+, VCSA 6.5+
...
.EXAMPLE
    PowerCLI C:\> Connect-CisServer -Server 192.168.1.51 -User administrator@vsphere.local -Password VMware1!
    PowerCLI C:\> Get-VAMIStatsList
.EXAMPLE
    PowerCLI C:\> Get-VAMIStatsList -Category Memory
.NOTES
	Created by  :: William Lam @lamw
	Edited by   :: Roman Gelman @rgel
	Requirement :: PowerCLI 6.5+, VCSA 6.5+
...
.EXAMPLE
    PowerCLI C:\> Connect-CisServer -Server 192.168.1.51 -User administrator@vsphere.local -Password VMware1!
    PowerCLI C:\> Get-VAMIStorageUsed
.NOTES
	Created by  :: William Lam @lamw
	Edited by   :: Roman Gelman @rgel
	Requirement :: PowerCLI 6.5+, VCSA 6.5+
...
.EXAMPLE
    PowerCLI C:\> Connect-CisServer -Server 192.168.1.51 -User administrator@vsphere.local -Password VMware1!
    PowerCLI C:\> Get-VAMIPerformance
.EXAMPLE
	PowerCLI C:\> Get-VAMIPerformance -Interval HOURS6
.EXAMPLE
	PowerCLI C:\> Get-VAMIPerformance Month MINUTES30 AVG
.EXAMPLE	
	PowerCLI C:\> Get-VAMIPerformance -Interval HOURS2 -Period Quarter -ExcludeZero |epcsv -notype .\Perf.csv
.NOTES
	Idea        :: William Lam @lamw
	Created by  :: Roman Gelman @rgel
	Requirement :: PowerCLI 6.5+, VCSA 6.5+
...
.EXAMPLE
    PowerCLI C:\> Connect-CisServer -Server 192.168.1.51 -User administrator@vsphere.local -Password VMware1!
    PowerCLI C:\> Get-VAMIService |ft -au
.EXAMPLE
	PowerCLI C:\> Get-VAMIService |? {$_.Startup -eq 'AUTOMATIC' -and $_.Health -ne 'HEALTHY'}
	Get all Unhealthy automatic services.
.EXAMPLE
    PowerCLI C:\> Get-VAMIService -Name rbd
.EXAMPLE
    PowerCLI C:\> Get-VAMIService rbd,vsphere-client
.NOTES
	Created by  :: William Lam @lamw
	Edited by   :: Roman Gelman @rgel
	Requirement :: PowerCLI 6.5+, VCSA 6.5+
...
.EXAMPLE
    PowerCLI C:\> Connect-CisServer -Server 192.168.1.51 -User administrator@vsphere.local -Password VMware1!
    PowerCLI C:\> Start-VAMIService -Name rbd
.EXAMPLE
	PowerCLI C:\> Get-VAMIService rbd,vsphere-client |Start-VAMIService -Verbose
.NOTES
	Created by  :: William Lam @lamw
	Edited by   :: Roman Gelman @rgel
	Requirement :: PowerCLI 6.5+, VCSA 6.5+
...
.EXAMPLE
    PowerCLI C:\> Connect-CisServer -Server 192.168.1.51 -User administrator@vsphere.local -Password VMware1!
    PowerCLI C:\> Stop-VAMIService -Name rbd
.EXAMPLE
	PowerCLI C:\> Get-VAMIService rbd,vsphere-client |Stop-VAMIService -Verbose
.NOTES
	Created by  :: William Lam @lamw
	Edited by   :: Roman Gelman @rgel
	Requirement :: PowerCLI 6.5+, VCSA 6.5+
...
.EXAMPLE
    PowerCLI C:\> Connect-CisServer -Server 192.168.1.51 -User administrator@vsphere.local -Password VMware1!
    PowerCLI C:\> Restart-VAMIService -Name rbd
.EXAMPLE
	PowerCLI C:\> Get-VAMIService rbd,vsphere-client |Restart-VAMIService -Verbose
.NOTES
	Idea        :: William Lam @lamw
	Created by  :: Roman Gelman @rgel
	Requirement :: PowerCLI 6.5+, VCSA 6.5+
...
.EXAMPLE
    PowerCLI C:\> Connect-CisServer -Server 192.168.1.51 -User administrator@vsphere.local -Password VMware1!
    PowerCLI C:\> Get-VAMIUser root
.EXAMPLE
	PowerCLI C:\> Get-VAMIUser |Format-Table -AutoSize
.NOTES
	Created by  :: William Lam @lamw
	Edited by   :: Roman Gelman @rgel
	Requirement :: PowerCLI 6.5+, VCSA 6.5+
...
.EXAMPLE
    PowerCLI C:\> Connect-CisServer -Server 192.168.1.51 -User administrator@vsphere.local -Password VMware1!
    PowerCLI C:\> New-VAMIUser lamw "William Lam" "VMware1!" -Role "operator" -Email "lamw@virtuallyghetto.com" -Verbose
.NOTES
	Created by  :: William Lam @lamw
	Edited by   :: Roman Gelman @rgel
	Requirement :: PowerCLI 6.5+, VCSA 6.5+
...
.EXAMPLE
    PowerCLI C:\> Connect-CisServer -Server 192.168.1.51 -User administrator@vsphere.local -Password VMware1!
    PowerCLI C:\> Remove-VAMIUser lamw
.EXAMPLE
    PowerCLI C:\> Remove-VAMIUser lamw -Verbose -Confirm:$false
.NOTES
	Created by  :: William Lam @lamw
	Edited by   :: Roman Gelman @rgel
	Requirement :: PowerCLI 6.5+, VCSA 6.5+
